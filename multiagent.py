...
class AgentRouter:
    ...
    def router_node(self,state: AgentState) -> AgentState:
        ...
        output = self.router_chain.run(question=question, file=file)
        try:
...
agentRouter = AgentRouter(routes=['pdf','csv','random'])
agent = agentRouter.build()
response = agent.invoke({"question": "How many rooms are available ?", "file": "HVAC.csv"})
